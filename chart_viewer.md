...
- 이동평균선 색상 고정 팔레트 적용(`ma5/10/20/120/180/240`)
- 돌파 대상 MA는 더 두껍게 하이라이트(특히 `ma10`은 추가 강조)
- 마지막 봉 정보 박스(종가/5/10/20/120/180/240이평) 표시
- 제목에 종목, 타임프레임, 돌파 강도, 데이터 기준일/시각, 장중/종가 상태 표시
- 월봉 차트 x축은 분기성 월(1/3/6/9월) 중심 라벨링으로 가독성 보강
- 캔들 좌우 여백을 축소해 유효 데이터 구간을 더 넓게 표시
